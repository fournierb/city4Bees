...
plot_Imp <- function(varimp, var, title){
  ...
  var.type = rep(c("Climate", "Urban", "Agricultural", "Forest", "Vegetation", "Hive"), each=4)
  var.type = factor(var.type, levels = c("Hive", "Vegetation", "Urban", "Agricultural", "Forest","Climate"))
...
require("magrittr")
require("ggpubr")
figure %>% ggexport(filename = "Fig3_Variable_Importance_revised.png",
                    width = 1000, height = 1000)
figure %>% ggexport(filename = "Fig3_Variable_Importance_revised.pdf",
                   width = 9, height = 9)
