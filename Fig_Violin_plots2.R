...
figure %>% ggexport(filename = "OUTPUT/Violin_plots/Fig_Violin_discrete.png",
                    width = 1200, height = 1200)

figure %>% ggexport(filename = "OUTPUT/Violin_plots/Fig_Violin_discrete.pdf",
                    width = 17, height = 17)
